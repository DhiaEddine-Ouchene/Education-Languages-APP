  ...
  return (
    <div className="space-y-6">
      ...
      {profile.subscriptionPlan === "FREE" ? (
        <p className="text-sm bg-primary-light text-primary-dark rounded-card p-3">White-label branding is applied to students on the <b>Pro</b> and <b>Ultimate</b> plans. You can configure it now and it activates when you upgrade.</p>
      ) : null}
      <BrandingForm
        initial={{
