...
async function callGemini<T>(prompt: string, schema: z.ZodTypeAny): Promise<T[]> {
...
Respond with ONLY a raw JSON object of the shape {"items": [...]}. No markdown fences, no commentary.`;
  ...
  return callGemini<VocabularyItem>(prompt, vocabularySetSchema);
}
...
Respond with ONLY a raw JSON object of the shape {"items": [...]}. No markdown fences, no commentary.`;
  ...
  return callGemini<GrammarItem>(prompt, grammarSetSchema);
}
